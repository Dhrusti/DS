...
namespace BussinessLayer
{
    public class PatientBLL
    {
        ...
        public CommonResponse GetAllAppointment(GetAllAppointmentReqDTO getAllAppointmentReqDTO)
        {
            ...
            if (role.Id == CommonConstant.Admin || role.Id == CommonConstant.Super_Admin)
            {
                NewSchedulingCount = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 1).Count();
                ReSchedulingCount = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 2).Count();
                DoneCount = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 4).Count();
                OtherCount = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 3).Count();
            ...
            else
            {
                ...
                ReSchedulingCount = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 2 && x.CreatedBy == getAllAppointmentReqDTO.ReceptionistId).Count();
                DoneCount = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 4 && x.CreatedBy == getAllAppointmentReqDTO.ReceptionistId).Count();
                OtherCount = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 3 && x.CreatedBy == getAllAppointmentReqDTO.ReceptionistId).Count();
                    ...
                    appoitmentlist = (from u in _dbContext.AppointmentMsts.Where(x => x.CreatedBy == getAllAppointmentReqDTO.ReceptionistId || x.CreatedBy != getAllAppointmentReqDTO.ReceptionistId)
                                     ...
                                     on u.CallTypeId equals l.Id
                                      ...
                                      select new { u, l, E }).ToList().Select((x, index) => new AppointmentList
                                      {
                                          ...
                                          PatientName = _commonHelper.DecryptString(x.u.PatientFirstName),
                                          ...
                                          UserId = x.u.Id,
                                          DOB = _commonHelper.DecryptString(x.u.PatientDob),
                                          CallType = AppointmentType,
                                          IsEditable = x.u.IsEditable,
                                          PatientEmail = _commonHelper.DecryptString(x.u.PatientEmail),
                ...
                if (getAllAppointmentReqDTO.GlobalSearch != null && !string.IsNullOrWhiteSpace(getAllAppointmentReqDTO.GlobalSearch))
                {
                    ...
                    //{
                       // DateTime dt = DateTime.Parse(date);
                        ...
                        var newSchedulinglist = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 1 && x.CreatedBy == getAllAppointmentReqDTO.ReceptionistId).ToList();
                        newSchedulinglist = newSchedulinglist.Where(x => _commonHelper.DecryptString(x.PatientDob) == getAllAppointmentReqDTO.GlobalSearch).ToList();
                        if (newSchedulinglist.Count > 0)
                        {
                            NewSchednulinglist = newSchedulinglist.Count();
                            appoitmentlist = appoitmentlist.Where(x => x.DOB == getAllAppointmentReqDTO.GlobalSearch).ToList();

                        }

                        var reschedulinglist = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 2 && x.CreatedBy == getAllAppointmentReqDTO.ReceptionistId).ToList();
                        reschedulinglist = reschedulinglist.Where(x => _commonHelper.DecryptString(x.PatientDob) == getAllAppointmentReqDTO.GlobalSearch).ToList();
                        if (reschedulinglist.Count > 0)
                        {
                            ReSchedulingList = reschedulinglist.Count();
                            appoitmentlist = appoitmentlist.Where(x => x.DOB == getAllAppointmentReqDTO.GlobalSearch).ToList();

                        }

                        var doneList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 4 && x.CreatedBy == getAllAppointmentReqDTO.ReceptionistId).ToList();
                        doneList = doneList.Where(x => _commonHelper.DecryptString(x.PatientDob) == getAllAppointmentReqDTO.GlobalSearch).ToList();

                        if (doneList.Count > 0)
                        {
                            Donelist = doneList.Count();
                            appoitmentlist = appoitmentlist.Where(x => x.DOB == getAllAppointmentReqDTO.GlobalSearch).ToList();
                        }

                        var otherList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 3 && x.CreatedBy == getAllAppointmentReqDTO.ReceptionistId).ToList();
                        otherList = otherList.Where(x => _commonHelper.DecryptString(x.PatientDob) == getAllAppointmentReqDTO.GlobalSearch).ToList();

                        if (otherList.Count > 0)
                        {
                            Otherlist = otherList.Count();
                            appoitmentlist = appoitmentlist.Where(x => x.DOB == getAllAppointmentReqDTO.GlobalSearch).ToList();
                        }
                   ...
                   // }
                    ...
                    if (role.Id == CommonConstant.Admin || role.Id == CommonConstant.Super_Admin)
                    {
                        ...
                        //    DateTime dt = DateTime.Parse(date1);
                             ...
                             newSchedulinglist = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 1).ToList();
                            newSchedulinglist = newSchedulinglist.Where(x => _commonHelper.DecryptString(x.PatientDob) == getAllAppointmentReqDTO.GlobalSearch).ToList();
                            if (newSchedulinglist.Count > 0)
                            {
                                NewSchednulinglist = newSchedulinglist.Count();
                             ...
                             reschedulinglist = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 2).ToList();
                            reschedulinglist = reschedulinglist.Where(x => _commonHelper.DecryptString(x.PatientDob) == getAllAppointmentReqDTO.GlobalSearch).ToList();
                            if (reschedulinglist.Count > 0)
                            {
                                ReSchedulingList = reschedulinglist.Count();
                             ...
                             doneList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 4).ToList();
                            doneList = doneList.Where(x => _commonHelper.DecryptString(x.PatientDob) == getAllAppointmentReqDTO.GlobalSearch).ToList();
                            ...
                            if (doneList.Count > 0)
                            {
                             ...
                             otherList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 3).ToList();
                            otherList = otherList.Where(x => _commonHelper.DecryptString(x.PatientDob) == getAllAppointmentReqDTO.GlobalSearch).ToList();
                      ...
                      //  }
                        ...
                        {
                             newSchedulinglist = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 1).ToList();
                            newSchedulinglist = newSchedulinglist.Where(x => _commonHelper.DecryptString(x.PatientFirstName).ToLower().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();

                            if (newSchedulinglist.Count > 0)
                            {
                                NewSchednulinglist = newSchedulinglist.Count();
                                appoitmentlist = appoitmentlist.Where(x => x.PatientName.ToLower().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();
                                //_commonHelper.DecryptString(x.u.PatientFirstName)
                            }

                            var AccountnewSchedulinglist = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 1).ToList();
                            AccountnewSchedulinglist = AccountnewSchedulinglist.Where(x => x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();

                            if (AccountnewSchedulinglist.Count > 0)
                            {
                                NewSchednulinglist = AccountnewSchedulinglist.Count();
                                appoitmentlist = appoitmentlist.Where(x => x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();
                            }
                        }
                        if (_commonRepo.getAllAppointment().Where(x => x.CallTypeId == 2).Count() > 0)
                        {
                            var reSchedulinglist = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 2).ToList();
                            reSchedulinglist = reSchedulinglist.Where(x => _commonHelper.DecryptString(x.PatientFirstName).ToLower().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();
                            ...
                            var AccountnewSchedulinglist = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 2).ToList();
                            AccountnewSchedulinglist = AccountnewSchedulinglist.Where(x => x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();

                            if (AccountnewSchedulinglist.Count > 0)
                            {
                                ReSchedulingList = AccountnewSchedulinglist.Count();
                                appoitmentlist = appoitmentlist.Where(x => x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();
                            }

                        }
                        if (_commonRepo.getAllAppointment().Where(x => x.CallTypeId == 4).Count() > 0)
                        {
                             doneList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 4).ToList();
                            doneList = doneList.Where(x => _commonHelper.DecryptString(x.PatientFirstName).ToLower().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();
                            ...
                            var AccountnewSchedulinglist = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 4).ToList();
                            AccountnewSchedulinglist = AccountnewSchedulinglist.Where(x => x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();

                            if (AccountnewSchedulinglist.Count > 0)
                            {
                                Donelist = AccountnewSchedulinglist.Count();
                                appoitmentlist = appoitmentlist.Where(x => x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();
                            }

                        }
                        if (_commonRepo.getAllAppointment().Where(x => x.CallTypeId == 3).Count() > 0)
                        {
                             otherList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 3).ToList();
                            otherList = otherList.Where(x => _commonHelper.DecryptString(x.PatientFirstName).ToLower().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();
                            ...
                            var AccountnewSchedulinglist = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 3).ToList();
                            AccountnewSchedulinglist = AccountnewSchedulinglist.Where(x => x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();

                            if (AccountnewSchedulinglist.Count > 0)
                            {
                                Otherlist = AccountnewSchedulinglist.Count();
                                appoitmentlist = appoitmentlist.Where(x => x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();
                            }
                        }
                    ...
                    {
                         newSchedulinglist = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 1 && x.CreatedBy == getAllAppointmentReqDTO.ReceptionistId).ToList();
                        newSchedulinglist = newSchedulinglist.Where(x => _commonHelper.DecryptString(x.PatientFirstName).ToLower().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();
                        ...
                        if (_commonRepo.getAllAppointment().Where(x => x.CallTypeId == 2 && x.CreatedBy == getAllAppointmentReqDTO.ReceptionistId && x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).Count() > 0)
                        {
                            ReSchedulingList = _commonRepo.getAllAppointment().Where(x => x.CallTypeId == 2 && x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).Count();
                            appoitmentlist = appoitmentlist.Where(x => x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();
                        }


                         doneList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 4 && x.CreatedBy == getAllAppointmentReqDTO.ReceptionistId).ToList();
                        doneList = doneList.Where(x => _commonHelper.DecryptString(x.PatientFirstName).ToLower().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();
                        ...
                        if (_commonRepo.getAllAppointment().Where(x => x.CallTypeId == 4 && x.CreatedBy == getAllAppointmentReqDTO.ReceptionistId && x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).Count() > 0)
                        {
                            Donelist = _commonRepo.getAllAppointment().Where(x => x.CallTypeId == 4 && x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).Count();
                            appoitmentlist = appoitmentlist.Where(x => x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();
                        }


                         otherList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 3 && x.CreatedBy == getAllAppointmentReqDTO.ReceptionistId).ToList();
                        otherList = otherList.Where(x => _commonHelper.DecryptString(x.PatientFirstName).ToLower().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();
                        ...
                        if (_commonRepo.getAllAppointment().Where(x => x.CallTypeId == 3 && x.CreatedBy == getAllAppointmentReqDTO.ReceptionistId && x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).Count() > 0)
                        {
                            Otherlist = _commonRepo.getAllAppointment().Where(x => x.CallTypeId == 3 && x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).Count();
                            appoitmentlist = appoitmentlist.Where(x => x.AccountNo.ToString().Contains(getAllAppointmentReqDTO.GlobalSearch.ToLower())).ToList();
                        }
        ...
        public CommonResponse AddAppoitment(AddAppoitmentReqDTO addAppoitmentReqDTO)
        {
            ...
            try
            {
                var checkAppointment = _commonRepo.getAllAppointment().FirstOrDefault(x => x.AccountNo == addAppoitmentReqDTO.AppointmentNumber);
                var checkDuplicateAppointment = _commonRepo.getAllAppointment().FirstOrDefault(x => x.AccountNo == addAppoitmentReqDTO.AppointmentNumber && x.ActualAppoitmentDate == Convert.ToDateTime(addAppoitmentReqDTO.ActualAppoitmentDate));
                ...
                DateTime dt = DateTime.Parse(date);
                //string dob = patientDOBEncrypt;
                //DateTime dt1 = DateTime.Parse(dob);
                appoitment.ActualAppoitmentDate = dt;
                appoitment.TaxId = addAppoitmentReqDTO.TaxId;
                appoitment.PatientFirstName = _commonHelper.EncryptString(addAppoitmentReqDTO.PatientName);
                //appoitment.PatientLastName = patientNameEncrtpt;
                appoitment.LastAppoitmentDate = addAppoitmentReqDTO.LastAppoitmentDate;
                appoitment.PatientMobileNo = _commonHelper.EncryptString(addAppoitmentReqDTO.PatientMobileNo);
                appoitment.PatientDob = _commonHelper.EncryptString(Convert.ToString(addAppoitmentReqDTO.PatientDob));
                ...
                appoitment.PatientEmail = _commonHelper.EncryptString(addAppoitmentReqDTO.PatientEmail);
                ...
                if (checkAppointment == null)
                {
                    ...
                    var Duration = _dbContext.DurationMsts.OrderBy(x => x.AppointmentId).LastOrDefault();

                    if (appoitmentlist != null && Duration != null)
                    {
        ...
        public CommonResponse AddRemark(AddRemarkReqDTO addRemarkReqDTO)
        {
            ...
            var user = _commonRepo.getAllUsers().FirstOrDefault(x => x.Id == addRemarkReqDTO.LoginUserId);
            var role = _dbContext.RoleMsts.FirstOrDefault(x => x.Id == user.Role);
            if ((addRemarkReqDTO != null) && (addRemarkReqDTO.AppointmentNumber > 0) && (addRemarkReqDTO.Remarks != null))
            {
                ...
                if (role.Id == CommonConstant.Admin || role.Id == CommonConstant.Super_Admin)
                {
                    ...
                    notification.Description = "You have received Remarks from" + " " + "Admin for" + " " + _commonHelper.DecryptString(user1.PatientFirstName);
                ...
                else
                {
                    ...
                    notification.SenderId = addRemarkReqDTO.LoginUserId;
                    notification.ReceiverId = addRemarkReqDTO.ReceiverId;
                    notification.AdminDescription = "You have received Remarks from Receptionist for" + " " + _commonHelper.DecryptString(user1.PatientFirstName);
        ...
        public CommonResponse GetAllAppointmentbyId(GetAllAppointmentbyIdReqDTO getAllAppointmentbyIdReqDTO)
        {
            ...
            try
            {
                ...
                if (appointmentList != null)
                {
                    ...
                    getAllAppointmentResDTO.PatientName = _commonHelper.DecryptString(appointmentList.PatientFirstName);
                    getAllAppointmentResDTO.PatientEmail = _commonHelper.DecryptString(appointmentList.PatientEmail);
                    getAllAppointmentResDTO.PatientMobileNo = _commonHelper.DecryptString(appointmentList.PatientMobileNo);
                    //  getAllAppointmentResDTO.PatientDob = appointmentList.PatientDob.ToString("MM/dd/yyyy");
                    getAllAppointmentResDTO.PatientDob = _commonHelper.DecryptString(appointmentList.PatientDob);
        ...
        public CommonResponse EditAppointment(EditAppointmentReqDTO editAppointmentReqDTO)
        {
            ...
            try
            {
                ...
                if (appointmentList != null)
                {
                    var patientNameEncrtpt = _commonHelper.EncryptString(editAppointmentReqDTO.PatientName);
                    var patientEmailEncrypt = _commonHelper.EncryptString(editAppointmentReqDTO.PatientEmail);
                    var patientPhoneEncrypt = _commonHelper.EncryptString(editAppointmentReqDTO.PatientMobileNo);
                    var patientDOBEncrypt = _commonHelper.EncryptString(Convert.ToString(editAppointmentReqDTO.PatientDob));
                    ...
                    appointmentList.PatientFirstName = patientNameEncrtpt;
                    appointmentList.PatientEmail = patientEmailEncrypt;
                    appointmentList.PatientMobileNo = patientPhoneEncrypt;
                    appointmentList.PatientDob = patientDOBEncrypt;
        ...
        public CommonResponse GetAllAppointmentByLocalSearch(GetAllAppointmentByLocalSearchReqDTO getAllAppointmentByLocalSearchReqDTO)
        {
            ...
            else
            {
                ...
                ReSchedulingCount = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 2 && x.CreatedBy == getAllAppointmentByLocalSearchReqDTO.ReceptionistId).Count();
                DoneCount = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 4 && x.CreatedBy == getAllAppointmentByLocalSearchReqDTO.ReceptionistId).Count();
                OtherCount = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 3 && x.CreatedBy == getAllAppointmentByLocalSearchReqDTO.ReceptionistId).Count();
            ...
            try
            {
                if (role.Id == CommonConstant.Admin || role.Id == CommonConstant.Super_Admin)
                {
                    appoitmentlist = (from u in _commonRepo.getAllAppointment()
                                      join l in _dbContext.CallTypeMsts.Where(x => x.CallTypeName   == AppointmentType)
                                     on u.CallTypeId equals l.Id
                                      join E in _commonRepo.getAllPhysician()
                                      on u.AppDoctorId equals E.Id
                ...
                {
                    appoitmentlist = (from u in _commonRepo.getAllAppointment().Where(x => x.CreatedBy == getAllAppointmentByLocalSearchReqDTO.ReceptionistId)
                                      join l in _dbContext.CallTypeMsts.Where(x => x.CallTypeName == AppointmentType)
                                     on u.CallTypeId equals l.Id
                                      join E in _commonRepo.getAllPhysician()
                                      on u.AppDoctorId equals E.Id
                ...
                if (getAllAppointmentByLocalSearchReqDTO.PageSearch != null && !string.IsNullOrWhiteSpace(getAllAppointmentByLocalSearchReqDTO.PageSearch))
                {
                    ...
                    if (role.Id == CommonConstant.Admin || role.Id == CommonConstant.Super_Admin)
                    {
                        ...
                        {
                            var newSchednulingList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 1).ToList();
                            newSchednulingList = newSchednulingList.Where(x => _commonHelper.DecryptString(x.PatientFirstName).ToLower().Contains(getAllAppointmentByLocalSearchReqDTO.PageSearch.ToLower())).ToList();
                            NewSchednulinglist = newSchednulingList.Count();
                        }
                        else
                        {
                        ...
                        {
                            var reschedulingList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 2).ToList();
                            reschedulingList = reschedulingList.Where(x => _commonHelper.DecryptString(x.PatientFirstName).ToLower().Contains(getAllAppointmentByLocalSearchReqDTO.PageSearch.ToLower())).ToList();
                            ReSchedulingList = reschedulingList.Count();
                        }
                        else
                        {
                            ReSchedulingList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 2).Count();

                        }

                        if (getAllAppointmentByLocalSearchReqDTO.AppointmentType == "Other")
                        {
                            var otherList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 3).ToList();
                            otherList = otherList.Where(x => _commonHelper.DecryptString(x.PatientFirstName).ToLower().Contains(getAllAppointmentByLocalSearchReqDTO.PageSearch.ToLower())).ToList();
                            Otherlist = otherList.Count();
                        }
                        else
                        {
                            Otherlist = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 3).Count();

                        }

                        if (getAllAppointmentByLocalSearchReqDTO.AppointmentType == "Done")
                        {
                            var doneList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 4).ToList();
                            doneList = doneList.Where(x => _commonHelper.DecryptString(x.PatientFirstName).ToLower().Contains(getAllAppointmentByLocalSearchReqDTO.PageSearch.ToLower())).ToList();
                            Donelist = doneList.Count();
                        }
                        else
                        {
                            Donelist = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 4).Count();
                    ...
                    else
                    {
                        if (getAllAppointmentByLocalSearchReqDTO.AppointmentType == "New_Scheduling" || string.IsNullOrWhiteSpace(getAllAppointmentByLocalSearchReqDTO.AppointmentType))
                        {
                            ...
                            var newSchednulingList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 1 && x.CreatedBy == getAllAppointmentByLocalSearchReqDTO.ReceptionistId).ToList();
                            newSchednulingList = newSchednulingList.Where(x => _commonHelper.DecryptString(x.PatientFirstName).ToLower().Contains(getAllAppointmentByLocalSearchReqDTO.PageSearch.ToLower())).ToList();
                            NewSchednulinglist = newSchednulingList.Count();
                        ...
                        if (getAllAppointmentByLocalSearchReqDTO.AppointmentType == "Re-Scheduling")
                        {
                            var reSchedulingList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 2 && x.CreatedBy == getAllAppointmentByLocalSearchReqDTO.ReceptionistId).ToList();
                            reSchedulingList = reSchedulingList.Where(x => _commonHelper.DecryptString(x.PatientFirstName).ToLower().Contains(getAllAppointmentByLocalSearchReqDTO.PageSearch.ToLower())).ToList();
                            ReSchedulingList = reSchedulingList.Count();
                        }
                        else
                        {
                            ReSchedulingList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 2 && x.CreatedBy == getAllAppointmentByLocalSearchReqDTO.ReceptionistId).Count();

                        }

                        if (getAllAppointmentByLocalSearchReqDTO.AppointmentType == "Other")
                        {
                            var otherList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 3 && x.CreatedBy == getAllAppointmentByLocalSearchReqDTO.ReceptionistId).ToList();
                            otherList = otherList.Where(x => _commonHelper.DecryptString(x.PatientFirstName).ToLower().Contains(getAllAppointmentByLocalSearchReqDTO.PageSearch.ToLower())).ToList();
                            Otherlist = otherList.Count();
                        }
                        else
                        {
                            Otherlist = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 3 && x.CreatedBy == getAllAppointmentByLocalSearchReqDTO.ReceptionistId).Count();

                        }

                        if (getAllAppointmentByLocalSearchReqDTO.AppointmentType == "Done")
                        {
                            var doneList = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 4 && x.CreatedBy == getAllAppointmentByLocalSearchReqDTO.ReceptionistId).ToList();
                            doneList = doneList.Where(x => _commonHelper.DecryptString(x.PatientFirstName).ToLower().Contains(getAllAppointmentByLocalSearchReqDTO.PageSearch.ToLower())).ToList();
                            Donelist = doneList.Count();
                        }
                        else
                        {
                            Donelist = _dbContext.AppointmentMsts.Where(x => x.CallTypeId == 4 && x.CreatedBy == getAllAppointmentByLocalSearchReqDTO.ReceptionistId).Count();
